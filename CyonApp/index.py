...
app.add_url_rule('/api/booking/rooms/<room_index>/choose', 'staff_choose_room', controllers.staff_choose_room, methods=["POST"])
...
app.add_url_rule('/api/booking/rooms/<room_index>/confirm', 'staff_confirm_room', controllers.staff_confirm_room, methods=["POST"])

app.add_url_rule('/staff/rent/reservations', 'reservations_to_rent', controllers.reservations_to_rent, methods=["GET"])
app.add_url_rule('/api/reservations/<reservation_id>', 'change_reservation', controllers.change_reservation, methods=['PUT'])
app.add_url_rule('/staff/paypal', 'paypal', controllers.paypal, methods=["GET"])
app.add_url_rule('/api/reservations/paypal/<reservation_id>', 'pay_reservation', controllers.pay_reservation,methods=['PUT'])
